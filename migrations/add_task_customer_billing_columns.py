"""
Add customer info, billable/non-billable line items, and completion notes columns to task table.
"""
import sqlite3
import sys
import os
...
def migrate():
    ...
    try:
        ...
        print(f"task table has {len(columns)} existing columns")
        ...
        conn.commit()
        print("\n[DONE] Task columns migration completed successfully!")
